...
const Skeleton: FC<{ grid?: boolean; count?: number }> = ({
  ...
  return (
    <div
      className={`grid gap-8 my-10 max-[620px]:my-4 ${grid || !pathname.startsWith("/shop")
    ...
    >
      {Array(count)
        ...
        .map((_, inx) => (
          ...
          >
            <div
              className={`relative w-full overflow-hidden bg-gray-200  ${grid || !pathname.startsWith("/shop")
